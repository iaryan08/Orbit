...
async function fixRpc() {
    try {
        ...
        console.log('Replacing submit_wyr_answer RPC with correct column (game_data)...');
        await client.query(`
      ...
      BEGIN
        ...
        SELECT id, game_data INTO v_session_id, v_current_state
        ...
        -- 6. Update (using game_data column)
        UPDATE public.game_sessions
        SET game_data = v_updated_state,
            updated_at = now()
    ...
    `);
        ...
        // Reload schema to be safe
        console.log('Reloading schema options...');
